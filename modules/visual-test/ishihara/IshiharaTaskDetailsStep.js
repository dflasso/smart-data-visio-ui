...
export default function IshiharaTaskDetailsStep({ typeBtn = "normal", results = null }) {
    ...
    const resolveTypeBtn = () => {
        ...
        } else if (typeBtn === "contained") {
            return (
                <Button variant="contained" startIcon={<Info />} onClick={handleClickOpen}>
                    Ver Resultados
                </Button>
            )
        } else {
